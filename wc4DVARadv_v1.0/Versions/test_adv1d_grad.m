function [phi] = test_adv1d_grad(xb,h,ht,L,a,dt,dx,nt,nx,B,R,Q,ystore)
...
[J,DJ]=calcJDJ(z,xb,h,ht,L,a,dt,dx,nt,nx,B,R,Q,ystore);
...
[J]=calcJDJ(z,xb,h,ht,L,a,dt,dx,nt,nx,B,R,Q,ystore);
