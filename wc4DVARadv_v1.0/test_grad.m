function [phi] = test_grad(xb,h,ht,a,dt,dx,nt,nx,B,R,Q,ystore)
...
%  w4dvar.m has been initialised properly. 
%
...
z=0.1*randn(nx*(nt+1),1);

for i=1:ic

% Calculate cost function and gradient with initial z
[DJ,J] = calcJDJ(z,xb,h,ht,a,dt,dx,nt,nx,B,R,Q,ystore);
...
figure(11), semilogx(alpha,phi); title('Verification of gradient calculation'), xlabel('\alpha'), ylabel('\Phi(\alpha)')
