...
% Model settings
N=40; n=8;  % Size of spatial and temporal domains
...
sigmaqt = 0.05; Lsqt = 0.005;  % True sigma_q and lengthscale for C_Q
sigmaot = 0.05;                  % True sigma_o
...
obs_f_x = fN(u);      % Obs frequency (space) (Regular spacing. =1 full obs)
...
sigmab = 0.1; Lsb = 0.005;  % Estimated sigmab and lengthscale for B
...
max_iterations=2500; tolerance=1d-3;
...
[kappaSx,kappaSp,kappaD] = HessNumCondNoCalc(n,N,fD,fR,fM,obs_f_x,mlvl,dt,xttraj(:,1))
