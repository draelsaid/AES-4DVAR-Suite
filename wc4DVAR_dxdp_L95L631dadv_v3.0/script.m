...
% Model settings
N=40; n=48;  % Size of spatial and temporal domains
...
sigmabt = 0.1; Lsbt = 0.025;  % True sigma_b and lengthscale for C_B
sigmaqt = 0.05; Lsqt = 0.01;  % True sigma_q and lengthscale for C_Q
sigmaot = 0.01;               % True sigma_o
...
obs_f_t = 5;      % Obs frequency (time) (Regular spacing. =1 obs all times)
obs_f_x = 2;      % Obs frequency (space) (Regular spacing. =1 full obs)
...
sigmab = 0.1; Lsb = 0.01;    % Estimated sigmab and lengthscale for B
sigmaq = 0.05; Lsq = 0.01;   % Estimated sigmaq and lengthscale for Q
sigmao = 0.01;               % Estimated sigmao
