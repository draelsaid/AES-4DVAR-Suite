...
% Model settings
N=50; n=45;  % Size of spatial and temporal domains
...
obs_f_t = 3;      % Obs frequency (time) (Regular spacing. =1 obs all times)
...
[~,kappaSp,kappaPSp,kappaD] = HessNumCondNoCalc(n,N,fD,fR,fM,obs_f_t,obs_f_x)
