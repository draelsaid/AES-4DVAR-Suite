...
% Model settings
N=50; n=50;  % Size of spatial and temporal domains
dt = 0.02;    % 0.025 dt => 3 hour time step (L95), 1 time unit is 5 days
...
sigmabt = 0.1; Lsbt = 0.04;  % True sigma_b and lengthscale for C_B
sigmaqt = 0.05; Lsqt = 0.02;  % True sigma_q and lengthscale for C_Q
sigmaot = 10;               % True sigma_o
...
sigmab = 0.1; Lsb = 0.04;   % Estimated sigmab and lengthscale for B
sigmaq = 0.05; Lsq = 0.02;   % Estimated sigmaq and lengthscale for Q
sigmao = 10;               % Estimated sigmao
